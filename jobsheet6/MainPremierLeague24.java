...
public class MainPremierLeague24 {
    ...
    public static void main(String[] args) {
        ...
        PremierLeagueService24 data = new PremierLeagueService24();
        ...
        for (int i = 0; i < data.leagues.length; i++) {
            ...
            PremierLeague24 team = new PremierLeague24(teams[i], play, goal, points);
            data.add(team);
        }
